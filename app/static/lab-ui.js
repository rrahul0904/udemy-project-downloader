...
function enhanceActivePanel(){enhanceDigitizerPanel(panel);enhanceSlurmPanel(panel);enhancePlumedPanel(panel);enhanceStructurePanel(panel);enhanceJournalPanel(panel);}

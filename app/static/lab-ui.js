...
import { enhanceJournalPanel } from './study-lab-adapters/journal.js';
import { enhanceCurvePanel } from './study-lab-adapters/curve.js';
...
function enhanceActivePanel(){enhanceDigitizerPanel(panel);enhanceSlurmPanel(panel);enhancePlumedPanel(panel);enhanceStructurePanel(panel);enhanceJournalPanel(panel);enhanceCurvePanel(panel);}
